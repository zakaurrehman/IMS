...
//                                         )}
//                                     </tr>
//                                     <tr key={hdGroup.id} className='border-b border-[var(--selago)] bg-gradient-to-r from-[var(--endeavour)] via-[var(--chathams-blue)] to-[var(--endeavour)]'>
//                                         {hdGroup.headers.map(
//                                             header =>
//                                                 <th key={header.id} className="relative px-6 py-2 text-left text-sm font-medium text-white uppercase">
...
//                                             className={`table_cell text-xs transition-colors ${pathName === '/invoices' ? 'md:py-1.5' : 'md:py-3'}`}
//                                         >
...
const Customtable = ({ data, columns, SelectRow, excellReport, setFilteredId, invisible }) => {
    ...
    return (
        <div className="flex flex-col relative">
            ...
            {/* SCROLL CONTAINER */}
            <div className="overflow-x-auto overflow-y-auto border-x border-[var(--selago)] md:max-h-[310px] 2xl:max-h-[550px] relative z-10">
