                        ...
                        {table.getRowModel().rows.map(row => (
                            ...
                            >
                                {row.getVisibleCells().map(cell => (
                                    ...
                                    >
                                        <div className="w-full px-4 py-2.5 bg-white rounded-lg shadow-md hover:shadow-lg transition-all duration-200 min-h-[44px] flex items-center justify-start whitespace-nowrap">
                                            {flexRender(cell.column.columnDef.cell, cell.getContext()) || '\u00A0'}
                                        </div>
                                    </td>
                                ))}
                        ...
                        <div className="space-y-2">
                            {row.getVisibleCells().map(cell => {
                                ...
                                return (
                                    <div key={cell.id}>
                                        <div className="text-xs font-bold text-blue-700">{cell.column.columnDef.header}</div>
                                        <div className="bg-white border border-gray-200 rounded-lg p-2 shadow-sm min-h-[44px] flex items-center justify-start whitespace-nowrap">
                                            {flexRender(cell.column.columnDef.cell, cell.getContext()) || '\u00A0'}
                                        </div>
                                    </div>
                                );
