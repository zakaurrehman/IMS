...
//                 <div className="w-full border-x border-[var(--selago)] max-h-[360px] md:max-h-[310px] 2xl:max-h-[550px] overflow-x-auto">
...
//                                         <th
//                                             key={header.id}
//                                             className="relative px-6 py-3 text-left text-sm text-white uppercase font-semibold hover:bg-[var(--rock-blue)] break-words whitespace-normal"
//                                         >
