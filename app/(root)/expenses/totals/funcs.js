        ...
        <div className="bg-[var(--selago)] max-h-[32rem] overflow-y-auto w-fit rounded-lg shadow-lg">
            <table>
                ...
                <tbody>
                    {filteredArr.map((z, i) => {
                        return (
                            <tr className="border-b border-[var(--rock-blue)]/30 hover:bg-[var(--rock-blue)]/20 text-[var(--port-gore)] transition-colors" key={i}>
                                ...
                                <td className="text-left text-[var(--port-gore)] p-2">{
                                    <NumericFormat
                                        value={z.amount}
                                        displayType="text"
                                        thousandSeparator
