                  ...
                  {row.getVisibleCells().map(cell => {
                    ...
                    return (
                      <td 
                        ...
                        className={`px-3 py-2.5 text-[13px] bg-[#ECF3FC]
                      ...
                      >
                        {!isDel ? (
                          <input
                            ...
                            className={`w-full px-2 py-1.5 border-none  rounded-lg shadow-md shadow-gray-500  text-[13px] font-normal text-gray-700 focus:outline-none focus:ring-0 
                              ${getTextAlignClass(cell.column.id)}
                            `}
