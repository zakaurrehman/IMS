...
const Customtable = ({ data, columns, invisible, SelectRow, excellReport, setFilteredData, ln }) => {
    ...
    return (
        <div className="flex flex-col relative">
            ...
            {/* SCROLL CONTAINER */}
            <div className="overflow-x-auto overflow-y-auto border-x border-[var(--selago)] md:max-h-[400px] 2xl:max-h-[550px] relative z-10">
                            ...
                            >
                                {row.getVisibleCells().map(cell => (
                                    <td 
                                        ...
                                        className="px-5 py-2.5 text-xs text-[var(--port-gore)] whitespace-nowrap leading-relaxed hover:bg-[var(--rock-blue)] hover:text-[var(--bunting)]"
                                        style={{ minWidth: '120px' }}
                                    >
