...
//   >
//     <div className="p-4 rounded-2xl bg-[#0066CC] text-white shadow-lg shadow-blue-900/10 group-hover:scale-105 transition-transform duration-300">
//       <Icon size={28} strokeWidth={2} />
//     </div>
//     <div>
//       <h3 className="text-xl font-bold text-[#0066CC] mb-3 group-hover:opacity-80 transition-opacity">
//         {title}
//       </h3>
...
//             className="text-4xl md:text-5xl font-bold text-[#0066CC] text-center mb-16"
//           >
...
//           >
//             <button className="px-10 py-4 bg-[#0066CC] text-white font-bold rounded-md hover:bg-[#0052A3] transition-all duration-300 shadow-md hover:shadow-lg hover:scale-105">
//               Learn More
//             </button>
//           </motion.div>
//         </div>
